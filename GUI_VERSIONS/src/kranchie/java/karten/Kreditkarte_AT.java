...
public class Kreditkarte_AT extends Karte {
     ...
     * aus den Werten geraden Stellen der Kreditkartennummer
     * (2,4,6,8,10,12,14,16) errechnet. 2. Die Werte der ungeraden Stellen der
     * Kreditkartennummer (1,3,5,7,9,11,13,15) werden mit 2 multipliziert,
     * falls das Ergebnis >= 10 ist wird der Wert 9 abgezogen. Die Zahlen
     * werden summiert. 3. Es wird die Summe der beiden Teilsummen gebildet und
     * Modulo 10 gerechnet. 4. Bei einem Ergebnis != 0 ist die
