...
public abstract class Karte {
	 ...
	 * 
	 * @author crunchie
	 * @return Boolean, true wird zurückgegeben, wenn beide Längen übereinstimmen,
	 *         false falls nicht.
	 */
	...
	/**
	 * Description: Die Methode prüft, ob die Länge der Kartennummer korrekt ist und
	 * nur positive Zahlen beinhaltet.
	 * 
	 * @author crunchie
	 * @return Boolean, Wert true wird zurückgegeben, wenn die Kartennummer die
	 *         richtige Länge hat und nur positive Zahlen beinhaltet. Der Wert false
	 *         wird zurückgegeben, wenn die Kartennummer zu kurz oder zu lang ist
