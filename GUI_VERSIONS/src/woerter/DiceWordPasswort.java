...
public class DiceWordPasswort extends Wort {
		...
		//Erstellt ein DiceWord-Passwort in der gewünschten Sprache mit der Anzahl von Wörtern.
		...
		public String genDWpasswd() throws IOException{
			...
			case (4): 	sprache = "eff";
			break;
			default:	JOptionPane.showMessageDialog(null, "Die Sprache " + language + " ist nicht verfügbar.");
						sprache = "";
			break;
			}
